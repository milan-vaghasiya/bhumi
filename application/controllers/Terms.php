...
class Terms extends MY_Controller
{
    ...
    public function getDTRows(){
        ...
        $result = $this->configuration->getTermsDTRows($data);
    ...
    public function edit(){     
        $data = $this->input->post();
        $this->data['dataRow'] = $this->configuration->getTerm($data);
        $this->data['typeArray'] = $this->termsTypeArray;
        $this->load->view($this->termsForm, $this->data);
    }
    ...
    public function delete(){
        ...
        if(empty($data['id'])):
            ...
            $checkData['columnName'] = ["conditions"];
            $checkData['value'] = $data['conditions'];
            ...
            $this->printJson($this->configuration->trash('terms',['id'=>$data['id']]));
        endif;
    }
}
?>